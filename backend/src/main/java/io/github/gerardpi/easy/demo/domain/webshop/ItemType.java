...
public enum ItemType {
    ...
    public static Optional<ItemType> fromCode(final String code) {
        return Stream.of(values())
                .filter(type -> type.code.equals(code))
                .findAny();
    }

    public static ItemType convertFromCode(final String code) {
     ...
     * Is case sensitive.
     */
    public static boolean isTypePrefix(final String typePrefix) {
