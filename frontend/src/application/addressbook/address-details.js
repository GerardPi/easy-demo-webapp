...
export class AddressDetails extends LitElement {
  ...
  render() {
    ...
    return html`
      <kor-input label="Country code" id="countryCode" ?readonly=${readOnly} value="${countryCode}"></kor-input>
      <kor-input label="City" id="city" ?readonly=${readOnly} value="${city}"></kor-input>
      <kor-input label="Postal code" id="postalCode" ?readonly=${readOnly} value="${postalCode}"></kor-input>
      <kor-input label="Street" id="street" ?readonly=${readOnly} value="${street}"></kor-input>
      <kor-input label="Housenumber" id="houseNumber" ?readonly=${readOnly} value="${houseNumber}"></kor-input>
